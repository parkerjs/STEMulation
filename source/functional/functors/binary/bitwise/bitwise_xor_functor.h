#ifndef BITWISE_XOR_FUNCTOR_H
#define BITWISE_XOR_FUNCTOR_H
...
/**
 * Binary function object class whose call returns the result of applying the bitwise "exclusive or" operation
 * between its two arguments (as returned by operator ^)
 */
template<typename T, typename Result = T>
class BitwiseXorFunctor
...
public:
    ...
    {
        return const_cast<const BitwiseXorFunctor &>(*this).evaluate(lhs, rhs);
    }

    /**
     * clone() function
     */
    inline virtual BitwiseXorFunctor<T, Result> *clone(void) const override
    {
        return new BitwiseXorFunctor<T, Result>(*this);
    }

    /**
     * create() function
     */
    inline static BitwiseXorFunctor<T, Result> *create(void)
    {
        return new BitwiseXorFunctor<T, Result>();
    }
    ...
    {
        return const_cast<BitwiseXorFunctor *>(this)->evaluate(lhs, rhs, 0);
    }
...
public:
    ...
    {
        return BinaryFunctorType::Enum::BitwiseXor;
    }
};
